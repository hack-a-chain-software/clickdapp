const { plasmicRootClassName, renderPlasmicElement } = props;
...
if (!priceFeedAbi || !troveManagerAbi || !borrowerOperationAbi) {
  return;
}
  ...
  <div className={"bos " + plasmicRootClassName}>
    ...
    <div className="confirm-wrapper">
      {renderPlasmicElement("button", {
        onClick: closeTrove,
        isDisabled: !state.address || state.isBlock || state.troveDebt === 0,
